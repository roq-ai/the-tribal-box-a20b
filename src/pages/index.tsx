  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash your creativity with The Tribal Box - a digital platform designed for sports and creative professionals to showcase, connect, and inspire. Ignite your passion, join our community today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1455849318743-b2233052fcff?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcmVhdGl2ZSUyMHNwb3J0c3xlbnwwfHx8fDE2OTQxNzIyNjl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your creativity with The Tribal Box - a digital platform designed for sports and creative professionals to showcase, connect, and inspire. Ignite your passion, join our community today!`}
            </Text>
            <Box
