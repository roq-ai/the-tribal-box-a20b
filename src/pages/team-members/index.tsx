  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.joined_at ? format(parseISO(record?.joined_at as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'left_at',
      header: 'Left At',
      accessorKey: 'left_at',
      cell: ({ row: { original: record } }: any) =>
        record?.left_at ? format(parseISO(record?.left_at as unknown as string), 'dd-MM-yyyy') : '',
    },
