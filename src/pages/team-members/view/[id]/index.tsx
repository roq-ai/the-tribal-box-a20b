          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  label="Joined At"
                  text={data?.joined_at ? format(parseISO(data?.joined_at as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Left At"
                  text={data?.left_at ? format(parseISO(data?.left_at as unknown as string), 'dd-MM-yyyy') : ''}
                />
