  ...
  const fetcher = useCallback(
    async () =>
      getGuests({
        ...
        order: params.order,
        searchTermKeys: ['interest.contains', 'location.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.visited_at ? format(parseISO(record?.visited_at as unknown as string), 'dd-MM-yyyy') : '',
    },
    { id: 'interest', header: 'Interest', accessorKey: 'interest' },
